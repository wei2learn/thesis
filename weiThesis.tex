...
\begin{titlepage}
        ...
        \Huge
   {\bf Order Basis and Kernel Basis Computation}
...
are often stated with the sum of the column degrees of the input matrix,
which is more precise and tighter than using just the degrees. In
addition, the shifted minimal bases computed by our algorithms are
more general than the standard minimal bases.
